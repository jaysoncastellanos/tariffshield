...
import {
  ...
  createCollection,
  useCallbackRef
} from "./chunk-P3YVTOWG.js";
import {
  usePrevious,
  useSize
} from "./chunk-YQG4X4U5.js";
import {
  Primitive,
...
var Select = (props) => {
  ...
  const [valueNode, setValueNode] = React18.useState(null);
  const [valueNodeHasChildren, setValueNodeHasChildren] = React18.useState(false);
  ...
  const triggerPointerDownPosRef = React18.useRef(null);
  const isFormControl = trigger ? form || !!trigger.closest("form") : true;
  const [nativeOptionsSet, setNativeOptionsSet] = React18.useState(/* @__PURE__ */ new Set());
      ...
      children: [
        (0, import_jsx_runtime6.jsx)(Collection.Provider, { scope: __scopeSelect, children: (0, import_jsx_runtime6.jsx)(
          SelectNativeOptionsProvider,
          {
            ...
            onNativeOptionAdd: React18.useCallback((option) => {
              setNativeOptionsSet((prev) => new Set(prev).add(option));
            }, []),
            onNativeOptionRemove: React18.useCallback((option) => {
...
var SelectTrigger = React18.forwardRef(
  (props, forwardedRef) => {
    ...
    const pointerTypeRef = React18.useRef("touch");
...
var SelectValue = React18.forwardRef(
  (props, forwardedRef) => {
...
var SelectIcon = React18.forwardRef(
  (props, forwardedRef) => {
...
var SelectContent = React18.forwardRef(
  (props, forwardedRef) => {
    const context = useSelectContext(CONTENT_NAME2, props.__scopeSelect);
    const [fragment, setFragment] = React18.useState();
    useLayoutEffect2(() => {
...
var SelectContentImpl = React18.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSelect,
    ...
    const composedRefs = useComposedRefs(forwardedRef, (node) => setContent(node));
    const [selectedItem, setSelectedItem] = React18.useState(null);
    const [selectedItemText, setSelectedItemText] = React18.useState(
      null
    );
    const getItems = useCollection(__scopeSelect);
    const [isPositioned, setIsPositioned] = React18.useState(false);
    const firstValidItemFoundRef = React18.useRef(false);
    React18.useEffect(() => {
      if (content) return hideOthers(content);
    }, [content]);
    useFocusGuards();
    const focusFirst2 = React18.useCallback(
      (candidates) => {
    ...
    const focusSelectedItem = React18.useCallback(
    ...
    const itemRefCallback = React18.useCallback(
      (node, value, disabled) => {
    ...
    const handleItemLeave = React18.useCallback(() => content?.focus(), [content]);
    const itemTextRefCallback = React18.useCallback(
      (node, value, disabled) => {
        const isFirstValidItem = !firstValidItemFoundRef.current && !disabled;
        const isSelectedItem = context.value !== void 0 && context.value === value;
        if (isSelectedItem || isFirstValidItem) {
...
var SelectItemAlignedPosition = React18.forwardRef((props, forwardedRef) => {
  const { __scopeSelect, onPlaced, ...popperProps } = props;
  const context = useSelectContext(CONTENT_NAME2, __scopeSelect);
  const contentContext = useSelectContentContext(CONTENT_NAME2, __scopeSelect);
  const [contentWrapper, setContentWrapper] = React18.useState(null);
  const [content, setContent] = React18.useState(null);
  const composedRefs = useComposedRefs(forwardedRef, (node) => setContent(node));
  const getItems = useCollection(__scopeSelect);
  const shouldExpandOnScrollRef = React18.useRef(false);
  const shouldRepositionRef = React18.useRef(true);
  const { viewport, selectedItem, selectedItemText, focusSelectedItem } = contentContext;
  const position = React18.useCallback(() => {
  ...
  const handleScrollButtonChange = React18.useCallback(
    (node) => {
...
var SelectPopperPosition = React18.forwardRef((props, forwardedRef) => {
  const {
    __scopeSelect,
    align = "start",
...
var SelectViewport = React18.forwardRef(
  (props, forwardedRef) => {
    const { __scopeSelect, nonce, ...viewportProps } = props;
    const contentContext = useSelectContentContext(VIEWPORT_NAME, __scopeSelect);
    const viewportContext = useSelectViewportContext(VIEWPORT_NAME, __scopeSelect);
    const composedRefs = useComposedRefs(forwardedRef, contentContext.onViewportChange);
    const prevScrollTopRef = React18.useRef(0);
...
var SelectGroup = React18.forwardRef(
  (props, forwardedRef) => {
...
var SelectLabel = React18.forwardRef(
  (props, forwardedRef) => {
...
var SelectItem = React18.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSelect,
      value,
    ...
    const [textValue, setTextValue] = React18.useState(textValueProp ?? "");
    ...
    return (0, import_jsx_runtime6.jsx)(
      SelectItemContextProvider,
      {
        ...
        textId,
        isSelected,
        onItemTextChange: React18.useCallback((node) => {
...
var SelectItemText = React18.forwardRef(
  (props, forwardedRef) => {
    ...
    const [itemTextNode, setItemTextNode] = React18.useState(null);
    const composedRefs = useComposedRefs(
      forwardedRef,
    ...
    const nativeOption = React18.useMemo(
...
var SelectItemIndicator = React18.forwardRef(
  (props, forwardedRef) => {
...
var SelectScrollUpButton = React18.forwardRef((props, forwardedRef) => {
  const contentContext = useSelectContentContext(SCROLL_UP_BUTTON_NAME, props.__scopeSelect);
  const viewportContext = useSelectViewportContext(SCROLL_UP_BUTTON_NAME, props.__scopeSelect);
  const [canScrollUp, setCanScrollUp] = React18.useState(false);
...
var SelectScrollDownButton = React18.forwardRef((props, forwardedRef) => {
  const contentContext = useSelectContentContext(SCROLL_DOWN_BUTTON_NAME, props.__scopeSelect);
  const viewportContext = useSelectViewportContext(SCROLL_DOWN_BUTTON_NAME, props.__scopeSelect);
  const [canScrollDown, setCanScrollDown] = React18.useState(false);
  const composedRefs = useComposedRefs(forwardedRef, viewportContext.onScrollButtonChange);
  useLayoutEffect2(() => {
    if (contentContext.viewport && contentContext.isPositioned) {
      let handleScroll22 = function() {
...
var SelectScrollButtonImpl = React18.forwardRef((props, forwardedRef) => {
  const { __scopeSelect, onAutoScroll, ...scrollIndicatorProps } = props;
  const contentContext = useSelectContentContext("SelectScrollButton", __scopeSelect);
  const autoScrollTimerRef = React18.useRef(null);
  const getItems = useCollection(__scopeSelect);
  const clearAutoScrollTimer = React18.useCallback(() => {
...
var SelectSeparator = React18.forwardRef(
  (props, forwardedRef) => {
...
var SelectArrow = React18.forwardRef(
  (props, forwardedRef) => {
...
var SelectBubbleInput = React18.forwardRef(
...
function useTypeaheadSearch(onSearchChange) {
  ...
  const handleTypeaheadSearch = React18.useCallback(
    (key) => {
  ...
  const resetTypeahead = React18.useCallback(() => {
    searchRef.current = "";
    window.clearTimeout(timerRef.current);
  }, []);
  React18.useEffect(() => {
